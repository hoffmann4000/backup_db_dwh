CREATE PROCEDURE [REPORTING].[UPDATE_DIM_ABONNEMENT]
...
AS
BEGIN
IF OBJECT_ID('REPORTING.DIM_ABONNEMENT', 'U') IS NOT NULL 

MERGE INTO REPORTING.DIM_ABONNEMENT AS T
    USING(SELECT * FROM BASELINE.ABONNOMENT_V) AS S
...
IF (SELECT ABONNEMENT_ID FROM REPORTING.DIM_ABONNEMENT WHERE ABONNEMENT_ID=-1) IS NULL 
INSERT INTO REPORTING.DIM_ABONNEMENT (ABONNEMENT_ID)
VALUES (-1)
